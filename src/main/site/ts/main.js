...
const suggestionsListElement = document.querySelector("#suggestions");
const sunSelectElement = document.querySelector("#sun");
const moonSelectElement = document.querySelector("#moon");
const risingSelectElement = document.querySelector("#rising");
...
function postAndUpdate() {
    ...
    fetch('http://localhost:4567/results', {
        ...
        .then((responseData) => updateSuggestions(responseData.matches));
